...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <link href="./monthbook.css" rel="stylesheet"  media="(min-width:600px)"></link>
    </head>
    <body>
...
<h2>'<?php echo $search_con; ?>'검색결과</h2>
  <h4 style="margin-top:30px;"><a href="./book.php">홈으로</a></h4>
<table style="width:90%">
                    <tr style="background-color:#798da7">
                    <th style="color: white";>번호<th style="color: white";>장르</th><th style="color: white";>제목</th><th style="color: white";>글쓴이</th>
                    </tr>
...
$sql2 = ("SELECT B_NUM,GENRE, B_NAME, AUTHOR from book where $catagory like '%$search_con%'");
